...
public interface ArchiveService {
    ...
    List<IoCRecord> getMatchingActiveEntries(String name, String value) throws ArchiveException;

    IoCRecord getActiveIoCRecordById(String id) throws ArchiveException;
